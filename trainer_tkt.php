...
<p style="margin: 10px;">Для <b>тренировки</b> билета нажмите на его название.</p>
<div class="tkt">
    <?php
    foreach ($tickets as $row) {
        $tkt_id = $row['tkt_id'];
        $name = $row['name'];
        echo "<a class=\"blk btn btn-outline-dark\" href=\"trainer.php?tkt_id=$tkt_id&name=$name\">$name</a>";
    } ?>
</div>
</div>
